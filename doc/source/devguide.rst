...
This section explains the basics for developers who are willing to 
contribute to the XStream project.
...
on `GitHub <https://github.com>`_ and fork the XStream repository by 
clicking the **Fork** button in the header of the 
`XStream repository <https://github.com/dgursoy/xstream>`__: 
...
then you should consider contributing back to the XStream project. For this, 
...
between your forked branch and the original XStream repository. 
